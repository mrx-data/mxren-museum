...
The first version is intentionally frontend-only. It uses local sample artifact data and does not include a backend, login, upload flow, database, cloud storage, or production deployment.
